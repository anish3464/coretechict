...
"""
from website.views import home, services, contact, cyber_security, network_security, collaboration, digital_transformation, chat_submit
...
urlpatterns = [
    ...
    path('api/chat-submit/', chat_submit, name='chat_submit'),
]
